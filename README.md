...
Please follow below link for the installtion instrutions:
https://bsg-confluence.broadcom.net/pages/viewpage.action?spaceKey=AO&title=Automated+Openshift+4.x+Cluster+install+on+VMware+vSphere
